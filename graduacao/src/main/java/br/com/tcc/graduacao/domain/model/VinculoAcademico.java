...
public class VinculoAcademico {
  ...
  public VinculoAcademico(Pessoa pessoa, CursoReferencia curso, TipoVinculo tipoVinculo, LocalDate dataIngresso,
  ...
  public CursoReferencia getCurso() {
    return curso;
  }

  public void setCurso(CursoReferencia curso) {
    this.curso = curso;
  }
