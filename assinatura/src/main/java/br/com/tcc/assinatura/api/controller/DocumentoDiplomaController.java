...
import br.com.tcc.assinatura.domain.service.DocumentoDiplomaService;
...
@Tag(name = "02 - Documentos de diploma", description = "Operacoes de documentos de diploma (read model)")
public class DocumentoDiplomaController {
  ...
  @PostMapping
  @Operation(summary = "Criar documento", description = "Cria um documento de diploma (read model).")
  ...
  public ResponseEntity<DocumentoDiplomaResponse> atualizar(@PathVariable Long id,
    ...
    return service.atualizar(id, request)
        ...
        .orElseGet(() -> {
          log.warn("Falha ao atualizar documento: nao encontrado id={}", id);
