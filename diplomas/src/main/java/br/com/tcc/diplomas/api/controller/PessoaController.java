...
import br.com.tcc.diplomas.api.mapper.PessoaMapper;
import br.com.tcc.diplomas.domain.service.PessoaService;
...
public class PessoaController {
  ...
  @PostMapping
  @Operation(summary = "Criar pessoa", description = "Cria uma pessoa (read model) no servico de diplomas.")
  public ResponseEntity<PessoaResponse> criar(@Valid @RequestBody PessoaRequest request, UriComponentsBuilder uriBuilder) {
    var salvo = service.criarPessoa(request);
