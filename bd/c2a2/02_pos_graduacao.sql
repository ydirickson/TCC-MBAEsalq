...
CREATE TABLE IF NOT EXISTS pessoa (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 2 INCREMENT BY 2) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS aluno_pos_graduacao (
  ...
  data_conclusao DATE,
  status VARCHAR(30) NOT NULL,
  CONSTRAINT ck_aluno_pos_conclusao CHECK (
...
CREATE TABLE IF NOT EXISTS documento_oficial_pos (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
