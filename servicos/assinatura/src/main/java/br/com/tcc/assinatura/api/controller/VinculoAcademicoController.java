...
import br.com.tcc.assinatura.domain.service.VinculoAcademicoService;
...
@Tag(name = "03 - Vinculos academicos", description = "Operacoes de cadastro e manutencao de vinculos academicos")
