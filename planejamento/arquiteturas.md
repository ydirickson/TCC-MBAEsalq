# 4. Tipos de arquitetura de replicação (DB Based, CDC+Kafka, EDA+Kafka)
...
## 4.2 Relação com os cenários (infraestrutura x arquitetura)
...
## 4.3 Relação com as métricas M1-M8
...
## 4.4 Hipóteses de comparação (para conclusão)
...
## 4.5 Regra de leitura dos resultados
