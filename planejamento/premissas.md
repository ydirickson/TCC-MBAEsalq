...
- Identificadores canônicos serão **numéricos (long)**, gerados por sequência/identity do banco; **não usar UUID**.
- Devemos **evitar chaves compostas**, preferindo chaves substitutas simples.
