# 4.2 Metodologia comparativa (execucao e analise)
...
## 4.2.3 Regra de comparacao (ordem obrigatoria)
...
## 4.2.4 Matriz minima de execucao
...
## 4.2.5 Protocolo de execucao por rodada
...
## 4.2.6 Padrao de identificacao das rodadas
...
## 4.2.7 Coleta por metrica (M1-M8)
...
## 4.2.8 Comandos-base de referencia
...
## 4.2.9 Template de registro por rodada
...
## 4.2.10 Template de comparacao por cenario
...
## 4.2.11 Regra de decisao consolidada
...
## 4.2.12 Ameacas a validade (checklist rapido)
