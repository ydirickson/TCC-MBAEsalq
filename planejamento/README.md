...
- [3. Cenários de replicação e regras](./regras-replicacao.md)
- [4. Metodologia comparativa (execução e análise)](./metodologia.md)
- [5. CDC+Kafka com Connect Sink (foco em Pessoa)](./cdckafka.md)
- [6. Escopo previsto (todos os domínios)](./escopo.md)
- [7. Métricas previstas (alto nível)](./metricas.md)
- [8. Pontos em aberto para decisão](./pontos-abertos.md)
- [9. Pendências de implementação (arquivo de trabalho)](./pendencias.md)
